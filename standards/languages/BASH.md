...
**Prefer modern CLI tools over bash loops** - Use `fd`, `parallel`, `xargs -0` instead of hand-written loops. See `hyperi-ai/standards/universal/CODE-STYLE.md` for full CLI utility preferences.
